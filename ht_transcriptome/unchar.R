...
setwd("/Users/tejashree/Documents/Projects/oyster/exp_data/Spring2017/transcriptome_2017/data_analysis/uncharacterized/trans_2")
...
testx <- read.csv2("/Users/tejashree/Documents/Projects/oyster/exp_data/Spring2017/transcriptome_2017/data_analysis/uncharacterized/trans_2/RI_2vsCon_trans2_combined_annot_top10.csv", 
                  sep=",", header=TRUE)
testy <- read.csv2("/Users/tejashree/Documents/Projects/oyster/exp_data/Spring2017/transcriptome_2017/data_analysis/uncharacterized/trans_2/RI_2vsCon_trans2_combined_uncharac.csv", 
                   sep=",", header=TRUE)
...
#write output 
write.csv(testnew_notunchar_uniq, file = "RI_2vsCon_trans2_newannot.csv",
          row.names = F)
